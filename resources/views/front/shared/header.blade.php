<nav>
    <div
        class="flex justify-between items-center px-8 py-2 md:py-1 bg-white h-[60px] border-b-2 border-b-main max-w-screen-2xl mx-auto">
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('home') }}">
                <img class="h-14" src="{{asset('assets/logo.png')}}" alt="Logo Hotel Estadio Navbar">
            </a>
        </div>
        ...
        <div class="hidden md:block bg-main rounded-xl">
            <a target="_blank" href="#" class="bg-main h-12 w-12 p-1 rounded-xl block">
