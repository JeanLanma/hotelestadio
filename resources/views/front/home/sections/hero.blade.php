    ...
    <div class="swiper-wrapper hero-bg bg-cover w-full h-screen relative">
        ...
        <div class="swiper-slide">
            ...
            <div class="dark-overlay absolute -z-10 top-0 left-0 h-full w-full overflow-hidden">
                <img class="w-full h-full bg-cover object-cover" src="{{ asset('/assets/img/hero/principal-1.jpg') }}"
                    alt="Hero Background Image">
            </div>

            <div
                class="text-white text-center flex flex-col justify-center gap-3 h-full z-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div class="mx-auto">
                    <img class="w-60" src="{{ asset('assets/logo.png') }}" alt="Logo Hotel Estadio">
                </div>
                <h2 class="text-5xl font-light uppercase" data-swiper-parallax-duration="400"
                    data-swiper-parallax="-300">
                    El placer de hospedarse
                </h2>
                ...
                <p class="text-lg px-10">
                    ...
                    Ven y disfruta de nuestras amenidades y servicios
                </p>
