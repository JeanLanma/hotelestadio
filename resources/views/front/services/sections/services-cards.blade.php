            ...
            <div class="max-w-screen-2xl mx-auto flex flex-wrap justify-center items-center">
                ...
                <div class="flex flex-col lg:max-h-80 xl:h-80 max-w-[22.5rem] my-8 h-[32rem] min-h-[32rem] lg:min-h-[39rem] sm:basis-1/2 sm:max-w-1/2 lg:basis-1/3 lg:max-w-1/3 px-2">
                    ...
                    <div class="h-52 md:h-72 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                        <picture>
                            <img class="w-full object-cover md:h-72 h-60" src="{{ asset('assets/img/rooms/simple.jpeg') }}" alt="Habitaciones Hotel Estadio">
                        </picture>
                ...
                <div class="flex flex-col lg:max-h-80 xl:h-80 max-w-[22.5rem] my-8 h-[32rem] min-h-[32rem] lg:min-h-[39rem] sm:basis-1/2 sm:max-w-1/2 lg:basis-1/3 lg:max-w-1/3 px-2">
                    ...
                    <div class="h-52 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                        <picture>
                            <img class="w-full object-cover md:h-72 h-60" src="{{ asset('assets/img/services/servicio-habitacion.jpg') }}" alt="Servicio a la habitación Hotel Estadio">
                        </picture>
                ...
                <div class="flex flex-col lg:max-h-80 xl:h-80 max-w-[22.5rem] my-8 h-[32rem] min-h-[32rem] lg:min-h-[39rem] sm:basis-1/2 sm:max-w-1/2 lg:basis-1/3 lg:max-w-1/3 px-2">
                    ...
                    <div class="h-52 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                        <picture>
                            <img class="w-full object-cover md:h-72 h-60" src="{{ asset('assets/img/services/wifi.jpg') }}" alt="Wi-FI Hotel Estadio">
                        </picture>
                ...
                <div class="flex flex-col lg:max-h-80 xl:h-80 max-w-[22.5rem] my-8 h-[32rem] min-h-[32rem] lg:min-h-[39rem] sm:basis-1/2 sm:max-w-1/2 lg:basis-1/3 lg:max-w-1/3 px-2">
                    ...
                    <div class="h-52 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                        <picture>
                            <img class="w-full object-cover md:h-72 h-60" src="{{ asset('assets/img/services/aire.jpg') }}" alt="Aire acondicionado Hotel Estadio">
                        </picture>
