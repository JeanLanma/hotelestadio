<section>
    ...
    <div class="w-full p-4 sm:px-10 mt-8">
        ...
        <div class="max-w-screen-2xl mx-auto flex flex-wrap justify-center items-center">
            ...
            <div
                class="flex flex-col lg:max-h-80 xl:h-80 max-w-[22.5rem] my-8 h-[32rem] min-h-[32rem] lg:min-h-[39rem] sm:basis-1/2 sm:max-w-1/2 lg:basis-1/3 lg:max-w-1/3 px-2">

                <div class="h-52 md:h-72 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                    <picture>
                        <img class="w-full object-cover md:h-72 h-60" src="{{ asset('assets/img/rooms/simple.jpeg') }}"
                            alt="Habitaciones Hotel Estadio">
                    </picture>

                    <div
                        class="w-20 h-20 rounded-full bg-main p-4 absolute left-1/2 -translate-x-1/2 -bottom-16 md:-bottom-28 lg:-bottom-10">
                        <img class="service-icon w-9 text-center mx-auto"
                            src="{{ asset('assets/icons/services/building.svg') }}" alt="Building">
                    </div>
                </div>
                ...
                <div class="p-4 sm:p-6 flex flex-col basis-2/3 xl:h-80 text-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold text-dark-medium leading-6">
                            ¡Descubre la comodidad en nuestras 33 habitaciones! 🛏️✨ Disfruta de todos los servicios que
                            mereces.
                        </p>
            ...
            <div
                ...
                <div class="h-52 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                    <picture>
                        <img class="w-full object-cover md:h-72 h-60"
                            src="{{ asset('assets/img/services/desayuno.jpg') }}" alt="Restaurant Photography">
                    </picture>

                    <div
                        class="w-20 h-20 rounded-full bg-main p-4 absolute left-1/2 -translate-x-1/2 -bottom-16 md:-bottom-28 lg:-bottom-10">
                        <img class="service-icon w-14 text-center mx-auto"
                            src="{{ asset('assets/icons/services/mug-hot.svg') }}" alt="Building">
                    </div>
                </div>
                ...
                <div class="p-4 sm:p-6 flex flex-col basis-2/3 xl:h-80 text-center">
                    ...
                    <div>
                        <p class="text-sm font-bold text-dark-medium leading-6">
                            ¡Despierta con sabor! Tenemos servicio de bebidas y snaks toda la noche y servicio de
                            restaurante de las 7:30am a 9:30 pm. ¡Te esperamos con una sonrisa! 😊🍳
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-bold text-dark-medium leading-6">
                            (Con horario de 7:30 AM a 9:30 PM)
                        </p>
            ...
            <div
                ...
                <div class="h-52 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                    <picture>
                        <img class="w-full object-cover md:h-72 h-60"
                            src="{{ asset('assets/img/services/servicio-habitacion.jpg') }}"
                            alt="Servicio a la habitación Hotel Estadio">
                    </picture>
            ...
            <div
                ...
                <div class="h-52 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                    <picture>
                        <img class="w-full object-cover md:h-72 h-60"
                            src="{{ asset('assets/img/services/television.jpg') }}" alt="Parking Photography">
                    </picture>
            ...
            <div
                ...
                <div class="h-52 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                    <picture>
                        <img class="w-full object-cover md:h-72 h-60" src="{{ asset('assets/img/services/wifi.jpg') }}"
                            alt="Wi-FI Hotel Estadio">
                    </picture>
                    ...
                    <div
                        ...
                        <svg hidden fill="#ffffff" xmlns="http://www.w3.org/2000/svg"
            ...
            <div
                ...
                <div class="h-52 lg:h-full min-h-5 basis-1/3 relative mb-8 md:mb-20 lg:mb-8">
                    <picture>
                        <img class="w-full object-cover md:h-72 h-60" src="{{ asset('assets/img/services/aire.jpg') }}"
                            alt="Aire acondicionado Hotel Estadio">
                    </picture>
